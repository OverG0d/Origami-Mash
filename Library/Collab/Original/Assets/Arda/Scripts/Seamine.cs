...
public class Seamine : SpawnableObject
{
    ...
    private void OnCollisionEnter(Collision col)
    {
        ...
        {
            GameObject obj = Instantiate(explosion, new Vector3(gameObject.transform.position.x, gameObject.transform.position.y, gameObject.transform.position.z), gameObject.transform.rotation);
            NetworkServer.Spawn(obj);        
            RpcExplosion();
            RespawnManager.instance.RpcDeSpawn(gameObject, startPosition);
        }
